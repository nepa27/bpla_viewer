...
export const createFlightPoints = ({svg, mapGroup, filteredFlights, projection, isSingleRegion,  setTooltip, height}) =>
{
        const flightPoints = mapGroup.selectAll("circle.flight-point")
          ...
          .on("mouseover", function(event, d) {
            d3.select(this).attr("r", 1 / (isSingleRegion ? 1 : 2)).attr("opacity", 1);
          ...
          .on("mouseout", function() {
            d3.select(this).attr("r", 1 / (isSingleRegion ? 1 : 2)).attr("opacity", 0.8);
