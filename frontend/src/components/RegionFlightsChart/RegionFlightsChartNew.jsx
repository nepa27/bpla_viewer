...
// import useD3FlightsChart from '../../d3/useD3FlightsChart';
...
export const RegionFlightsChart = memo(({ data, onBrush = null }) => {
  ...
  const [svgContainerHeight, setSvgContainerHeight] = useState('400px');
  ...
  useD3BarChart(svgRef, containerRef, processedData, onBrush, 'flights', isMobile);
