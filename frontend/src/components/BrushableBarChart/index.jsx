  ...
  useEffect(() => {
    ...
    const brush = brushX()
      ...
      .on('brush end', (event) => {
        ...
        // Используем более надежный способ определения индексов
        ...
        if (startIndex === endIndex) {
          // Получаем дату для начального индекса
          const startDate = new Date(dates[startIndex]);

          // Рассчитываем долю внутри месяца
          ...
          // Рассчитываем начальный и конечный день
          ...
          console.log('Один месяц:', 'start:', finalStartDate, 'end:', finalEndDate);
        ...
        // Для начального месяца - определяем день на основе позиции внутри столбца
        ...
        // Для конечного месяца - определяем день на основе позиции внутри столбца
        ...
        console.log('Несколько месяцев:', 'start:', finalStartDate, 'end:', finalEndDate);
...
//         // console.log('extendedEndDate = ', extendedEndDate)
