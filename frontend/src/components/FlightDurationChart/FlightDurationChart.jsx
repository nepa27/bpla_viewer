...
export const FlightDurationChart = memo(({ flightData, dateRange }) => {
  ...
  useEffect(() => {
    ...
    // Подготовка данных: группировка по дате и суммирование длительности
    ...
    for (const flight of flightData) {
      ...
      if (dateRange && Array.isArray(dateRange) && dateRange.length === 2) {
        ...
        if (startDate && endDate) {
          ...
          // Устанавливаем время для точного сравнения
  ...
  }, [flightData, dateRange]); // ✅ Зависит от dateRange
...
// export const FlightDurationChart = memo(({ flightData, onBrush }) => {
//   const svgRef = useRef();
//   const containerRef = useRef();
